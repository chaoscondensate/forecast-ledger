...
func TestRemovedLegacyPathsStayAbsent(t *testing.T) {
	...
	for _, relative := range []string{
		...
		"internal/schema/upstream/forecast-ledger/v2.0.1",
		...
		"internal/schema/upstream/forecast-ledger/v2.1.0/docs/compatibility-v1-v2.md",
		"internal/schema/upstream/forecast-ledger/v2.1.0/tests/vectors/forecast-seal-v1.json",
		"internal/schema/upstream/forecast-ledger/v2.1.0/tests/vectors/legacy-v1.3.0-sha256.json",
