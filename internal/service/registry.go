...
func OperationDefinitions() []OperationDefinition {
	definitions := []OperationDefinition{
		...
		definition(OperationTargetBuild, "target build", "target_build", SelectionTarget, "", RequestNone,
			RequestField{Name: "scope", Type: "string", Description: "Target scope", Enum: []string{"forecast", "lifecycle"}},
			RequestField{Name: "head", Type: "string", Description: "Lifecycle head event ID"},
			RequestField{Name: "checkpoint", Type: "string", Description: "Explicit lifecycle checkpoint ID"},
			RequestField{Name: "recorded_at", Type: "string", Description: "Explicit lifecycle checkpoint recording time"}),
		...
		definition(OperationTimestampStamp, "timestamp stamp", "timestamp_stamp", SelectionForecast, "", RequestNone,
			RequestField{Name: "scope", Type: "string", Description: "Evidence scope", Enum: []string{"forecast", "lifecycle"}},
			RequestField{Name: "head", Type: "string", Description: "Lifecycle head event ID"},
