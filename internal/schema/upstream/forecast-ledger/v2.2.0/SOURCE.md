# Forecast Ledger schema v2.2.0

These retained files are unchanged from the `v2.2.0` release at
`https://github.com/chaoscondensate/schema`.

- Commit: `ae02de9ebca3eb2ae87c480596bf620bdcdced11`
- Annotated tag object: `8feb323ce895a6a197183c4eb857a55463648873`
- Published: `2026-09-22T21:44:11Z`
...
The application retains only files needed for the v2 runtime, reference
semantics, and deterministic v2 conformance. Superseded contract material is
not bundled.
...
| `schema/forecast-ledger.schema.json` | `6a048928f2573519fd25988ba23f0006b6f8d84eb2f7179d7ff8edd7affa4f9e` |
...
`SOURCE.md` is application provenance and is not an upstream release file.
